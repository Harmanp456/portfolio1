      ...
      <AnimatePresence mode="wait">
        {loading && (
          ...
          >
            ...
            {/* Subtle grid */}
            <div className="absolute inset-0 opacity-[0.03] bg-[linear-gradient(transparent_49.5%,#fc4a1f_49.5%,#fc4a1f_50.5%,transparent_50.5%),linear-gradient(90deg,transparent_49.5%,#fc4a1f_49.5%,#fc4a1f_50.5%,transparent_50.5%)] bg-[size:80px_80px]" />
            ...
            >
              ...
              <div className="relative">
                <motion.span
                  className="text-[7rem] sm:text-[10rem] md:text-[14rem] font-outfit font-black leading-none tracking-tight tabular-nums"
                  style={{
                    background:
                      "linear-gradient(135deg, #fc4a1f, #ac0057)",
                ...
                {/* Reflection */}
                <span
                  className="absolute top-full left-0 right-0 text-[7rem] sm:text-[10rem] md:text-[14rem] font-outfit font-black leading-none tracking-tight tabular-nums opacity-[0.06] scale-y-[-1]"
                  style={{
                    background:
                      "linear-gradient(135deg, #fc4a1f, #ac0057)",
                    WebkitBackgroundClip: "text",
