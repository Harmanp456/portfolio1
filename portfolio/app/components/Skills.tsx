...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={sectionRef} className="relative py-20 md:py-28 lg:py-32 px-6 md:px-12">
      {/* Ambient light */}
                ...
                <div className="flex flex-wrap gap-2">
                  {skillList.map((skill, skillIdx) => (
                    <motion.span
                      ...
                      className="px-3 py-1.5 text-[11px] font-mono font-medium rounded-md bg-accent/[0.06] text-accent/80 border border-accent/10 cursor-default transition-all duration-300 hover:bg-accent hover:text-background hover:shadow-[0_0_20px_#fc4a1f44] hover:scale-105"
                    >
                      {skill}
                    </motion.span>
                  ))}
