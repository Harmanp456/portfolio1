...
const socials = [
  ...
  {
    label: "LeetCode",
    href: "https://leetcode.com/u/iharmansaini/",
    icon: LeetCodeIcon,
    handle: "@iharmansaini",
  },
  {
...
export default function Contact() {
  ...
  function buildMailtoLink(fromName: string, fromEmail: string, body: string) {
    ...
    return `mailto:${contactReceiverEmail || "iharmansaini51@gmail.com"}?subject=${subject}&body=${content}`;
  }
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setFeedbackMessage(
        autoReplyFailed
          ? "Message sent to Harmanpreet Kaur HK successfully. Auto-reply could not be sent right now."
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className="relative py-20 md:py-28 lg:py-32 px-6 md:px-12"
    >
      {/* Ambient light */}
          ...
          >
            ...
            <div className="mb-10">
              ...
              <p className="text-secondary leading-relaxed">
                I&apos;m open to internship extensions, full-time opportunities,
                freelance collaborations, or just a great tech conversation.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-10">
              <div className="flex items-center gap-3 p-3 rounded-lg border border-border/30 bg-surface/20">
                ...
                <span className="text-sm text-secondary">Mohali, Punjab, India</span>
              </div>
              <div className="flex items-center gap-3 p-3 rounded-lg border border-border/30 bg-surface/20">
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="glow-button w-full py-4 rounded-xl bg-gradient-to-r from-accent to-accent-hot text-primary font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-3 hover:shadow-[0_0_25px_rgba(252,74,31,0.3)] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
              >
                {status === "loading" ? (
                  <>
